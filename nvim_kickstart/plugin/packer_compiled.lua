...
_G.packer_plugins = {
  ...
  ["telescope-fzf-native.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/opt/telescope-fzf-native.nvim",
  ...
  ["vim-rhubarb"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/vim-rhubarb",
    url = "https://github.com/tpope/vim-rhubarb"
  },
  ["vim-sleuth"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/vim-sleuth",
